...
<body>
    ...
    <section id="blog">
        ...
        <div class="blog-post">
            ...
            <p>Stay updated with the latest Codeforces contests:</p>
            <ul>
                <div>
                <li><a href="https://codeforces.com/contests">Codeforces Contests</a></li>
                </div>
                <div>
                 <li><a href="https://www.codechef.com/contests">Codechef Contests</a></li>
                 </div>
                <!-- Add more contest links as needed -->
            </ul>
        </div>     
